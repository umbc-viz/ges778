...
Some notes on wrangling data for visualization. We won't have time to go into a lot of detail, so please use the package docs for [`dplyr`](https://dplyr.tidyverse.org/), [`tidyr`](https://tidyr.tidyverse.org/), and [`forcats`](https://forcats.tidyverse.org/) as reference, and chapters 3 & 5 of @wickham2023

Also, for folks who haven't yet taken GES 668, Building Spatial Datasets, see that class's [online notes](https://bldgspatialdata.github.io/website/), especially [Week 4](https://bldgspatialdata.github.io/website/weeks/week_04.html).

::: {.aside}
I was able to quickly get the notes for our class set up by copying the basic template [Eli](https://github.com/elipousson) was using for Building Spatial Datasets. Shout out to open source.
:::

Some concerns in wrangling data as they relate to our work with ggplot:

- the shape (is it a [tidy format](https://r4ds.hadley.nz/data-tidy.html), i.e. has observations of given types in rows and features/variables in columns)
...
- Some indicator labels are unclear, but because I read the [data documentation](https://data.cdc.gov/d/swc5-untb), I know how to relabel them
