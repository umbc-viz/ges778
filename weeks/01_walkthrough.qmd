...
wages |>
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = "Adults ages 25+ with positive earnings, 2022")
```
...
#| tbl-cap: Median individual earnings, adults ages 25+ with positive earnings, 2022 
#| tbl-cap-location: top
wages |>
  filter(dimension == "total") |>
...
wages |>
  ...
  labs(x = NULL, y = NULL, fill = NULL,
       title = "Median individual earnings",
       subtitle = "Adults ages 25+ with positive earnings by sex, Maryland, 2022") +
...
wages |>
  ...
  labs(x = NULL, y = NULL, fill = NULL,
       title = "Median individual earnings",
       subtitle = "Adults ages 25+ with positive earnings by full-time status, Maryland, 2022") +
  theme(plot.subtitle = element_textbox_simple(margin = margin(0.2, 0, 0.2, 0, "lines")))
```
...
#| tbl-cap: Median individual earnings, adults ages 25+ with positive earnings by sex and full-time status, 2022 
#| tbl-cap-location: top 
wages |>
...
wages |>
  ...
  labs(x = NULL, y = NULL, fill = NULL,
       title = "Median individual earnings",
       subtitle = "Adults ages 25+ with positive earnings by sex and full-time status, Maryland, 2022") +
  theme(plot.subtitle = element_textbox_simple(margin = margin(0.2, 0, 0.2, 0, "lines")),
...
wages |>
  ...
  labs(x = NULL, y = NULL, fill = NULL,
       title = "Median individual earnings",
       subtitle = "Adults ages 25+ with positive earnings by educational attainment, Maryland full-time workers, 2022") +
  theme(plot.subtitle = element_textbox_simple(margin = margin(0.2, 0, 0.2, 0, "lines")))
```
...
2. Browse through the Data Visualisation Catalogue [@Ribecca2024] and see if you find any other chart types that would be appropriate for visualizing the sex and education chart (@fig-wages-edu-sex). Which chart types would be better, especially for highlighting the gaps or exploring other aspects of the story? 
3. Following question 2, Wilke gives a brief example in [section 6.3](https://clauswilke.com/dataviz/visualizing-amounts.html#dot-plots-and-heatmaps) of switching from bar charts to dot plots; how could this be adapted here?
