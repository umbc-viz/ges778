...
ggplot(sex_x_edu, aes(x = edu, y = earn_q50, fill = sex)) +
  ...
  labs(title = "Median earnings by sex & education, Maryland, 2022")
```
...
gg +
  ...
  labs(title = "Median individual earnings",
       subtitle = "Adults ages 25+ working full time by sex and educational attainment, Maryland, 2022",
...
sex_x_edu |>
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = "Median individual earnings, Maryland adults ages 25+ working full time by sex and educational attainment, 2022",
       caption = "Source: Analysis of US Census Bureau American Community Survey, 2022 5-year estimates")
```
